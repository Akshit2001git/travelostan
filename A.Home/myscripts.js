...
function f11() {
  ...
  if (name.length == 0) {
    ...
    document.getElementById("t1").innerHTML =
      "Fields With * Can't Be Left Empty!!";
  }
}
function fL() {
  var name = document.getElementById("iL").value;
  ...
  if (
    ...
    if (l < 6) {
      ...
      document.getElementById("t4").innerHTML =
        "Password Should Have an uppercase, a Lowercase, a Digit and a Special Character";
    }
  }
}
function f44() {
...
function f6() {
  ...
  var v6 = "Correct";
  var v7 = "",
    v8 = "Fields With * Can't Be Left Empty!!";
...
function check() {
  ...
  if (name == "Shimla" || name == "shimla") {
    document.getElementById("link").href = "/B.Shimla/shimla.html";
    ...
    document.getElementById("link").href = "/C.Varanasi/varanasi.html";
    document.getElementById("link").target = "_blank";
  } else {
